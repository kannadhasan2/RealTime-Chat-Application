...
const Sidebar = (setSelectedUserDetails) => {
    const {selectedUser,setSelectedUser} = setSelectedUserDetails
    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser? "max-md:hidden":""}`}>
      <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
            ...
            <input type="text" placeholder='Search User...' className='bg-transparent border-none outline-none text-while text-xs placeholder-[#c8c8c8] flex-1' />
        </div>
      </div>
      <div className='flex flex-col'>
        {
            userDummyData.map((user,index)=>(
                ...
                `}> 
                    ...
                    <div className='flex flex-col leadng-5'>
                        <p>{user.fullName}</p>
                        {
