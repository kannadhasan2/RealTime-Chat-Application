  ...
  return (
    <div className='border w-full h-screen sm:px-[15%] sm:py-[5%]'>
        <div className={`backdrop-blur-xl border-2 border-gray-600 rounded-2xl 
            ...
            <ChatContainer selectedUser = {selectedUser} setSelectedUserdUser = {setSelectedUser} /> 
            <RightSidebar selectedUser = {selectedUser} setSelectedUserdUser = {setSelectedUser} />
        </div>
    </div>
  )
}
